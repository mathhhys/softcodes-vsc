-- ============================================================================
-- Fix: Replace existing deduct_user_credits function
-- ============================================================================
-- The current function uses INTEGER for credits, which causes fractional loss
-- This script drops the old function and creates the new one with NUMERIC(10,2)
-- ============================================================================

-- Step 1: Drop the old function (the one with integer credits)
DROP FUNCTION IF EXISTS public.deduct_user_credits(uuid, integer, numeric, text, jsonb);

-- Step 2: Create the new function with NUMERIC(10,2) parameters
...
-- 1. Verify function was created with correct signature
SELECT proname, pg_get_function_arguments('public.deduct_user_credits'::regproc)
FROM pg_proc 
...
-- 2. Test the function (replace YOUR_USER_UUID with actual UUID)
...
-- 3. Check your current credits column type
