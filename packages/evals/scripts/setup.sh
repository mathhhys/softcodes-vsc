...
build_extension() {
  echo "🔨 Building the Softcodes extension..."
...
echo -n "🗄️ Syncing Softcodes evals database... "
...
read -p "💻 Do you want to build a new version of the Softcodes extension? [currently $current_version] (y/N): " build_extension
